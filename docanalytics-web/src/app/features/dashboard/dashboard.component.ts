...
export class DashboardComponent {
  ...
  protected readonly compareLink = computed(() => [
    '/site',
  ...
  protected readonly busy = computed(
    () =>
      this.dash.summaryLoading() ||
      this.dash.failuresLoading() ||
      this.dash.throughputLoading() ||
      this.dash.distributionLoading(),
  );
